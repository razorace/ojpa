...
void UI_DrawTotalForceStars(Rectangle *rect, float scale, vec4_t color, int textStyle);
void UI_DrawForceStars(Rectangle *rect, float scale, vec4_t color, int textStyle, int findex, int val, int min, int max) ;
