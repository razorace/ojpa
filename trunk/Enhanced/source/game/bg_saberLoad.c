...
//[SaberSys]
stringID_table_t SaberBlockedTable[] =
{
	ENUM2STRING(BLOCKED_NONE),
	ENUM2STRING(BLOCKED_BOUNCE_MOVE),
	ENUM2STRING(BLOCKED_PARRY_BROKEN),	
	ENUM2STRING(BLOCKED_ATK_BOUNCE),		
	ENUM2STRING(BLOCKED_UPPER_RIGHT),
	ENUM2STRING(BLOCKED_UPPER_LEFT),
	ENUM2STRING(BLOCKED_LOWER_RIGHT),
	ENUM2STRING(BLOCKED_LOWER_LEFT),
	ENUM2STRING(BLOCKED_TOP),
	ENUM2STRING(BLOCKED_UPPER_RIGHT_PROJ),
	ENUM2STRING(BLOCKED_UPPER_LEFT_PROJ),
	ENUM2STRING(BLOCKED_LOWER_RIGHT_PROJ),
	ENUM2STRING(BLOCKED_LOWER_LEFT_PROJ),
	ENUM2STRING(BLOCKED_TOP_PROJ),
	ENUM2STRING(BLOCKED_BACK),
	"",	-1
};
